...
This repository is a single content file: `vocab.md` at the root. All vocabulary entries live there; there are no source, test, or asset directories. If you add supplementary materials, keep them in the root and document them here to avoid hidden structure.
...
No build system or scripts are configured. Edit `vocab.md` in any editor; use your editor's Markdown preview if you want to review formatting before submitting changes.
